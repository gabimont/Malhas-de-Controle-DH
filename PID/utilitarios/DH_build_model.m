...
%% Paths
% Esse script vive em utilitarios/, entao rootDir = pai (raiz do projeto).
...
for k = 1:numel(variantes)
    ...
    % Match DH.mat do Mirko: simulacao arranca em theta=0 (em vez de theta_e).
    % A linearizacao acima ja usou o theta_e correto, entao A,B nao mudam.
    Xe(8) = 0;
